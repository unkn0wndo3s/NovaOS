...
Sur Windows, le script `build_and_run.bat` suppose que `clang`, `ld.lld`, `xorriso`, `qemu-system-x86_64` et `Limine\limine.exe` sont accessibles dans le PATH.
...
- Ce projet est inspiré des exemples bare-bones Limine. Marque et copyright respectifs aux auteurs.
